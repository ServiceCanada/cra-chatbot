module.exports = function(grunt) {
	grunt.initConfig({
				...
				files: [
					{
						expand: true,
						flatten: true,
						src: 'src/js/cra-chatbot.js',
						dest: 'dist/',
					},
					{
						expand: true,
						flatten: true,
						src: 'src/css/cra-chatbot.css',
						dest: 'dist/',
					}
				]
			}
		...
		uglify: {
			dist: {
				files: {
					'dist/cra-chatbot.min.js': ['src/js/cra-chatbot.js']
				}
			}
		},
		...
		cssmin: {
			dist: {
				files: {
					'dist/cra-chatbot.min.css': ['src/css/cra-chatbot.css']
				}
			}
		},
		...
		usebanner: {
			taskName: {
				...
				files: {
					src: [ 'dist/cra-chatbot.css', 'dist/cra-chatbot.min.css', 'dist/cra-chatbot.js', 'dist/cra-chatbot.min.js' ]
				}
			}
		},
